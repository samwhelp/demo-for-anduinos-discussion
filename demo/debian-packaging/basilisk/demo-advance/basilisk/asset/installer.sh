...
## # Install basilisk
##
## * https://github.com/samwhelp/demo-for-anduinos-discussion/blob/main/demo/installer/basilisk/install.sh
##
...
mod_project_install_bin () {
	...
	echo
	echo ln -sf "/usr/share/basilisk/basilisk" "${des_bin_dir_path}/basilisk"
	ln -sf "/usr/share/basilisk/basilisk" "${des_bin_dir_path}/basilisk"
...
cat << __EOF__ | tee "${des_applications_dir_path}/basilisk.desktop"
[Desktop Entry]
Version=1.0
