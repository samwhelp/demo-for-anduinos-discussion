...
DEFAULT_SUBJECT_NAME="basilisk"
REF_SUBJECT_NAME="${REF_SUBJECT_NAME:=$DEFAULT_SUBJECT_NAME}"


REF_REPO_ARCHIVE_EXTRACT_DIR_NAME="basilisk"
REF_REPO_ARCHIVE_FILE_NAME="basilisk-20250703124711.linux-x86_64-gtk3.tar.xz"
REF_REPO_ARCHIVE_URL="https://dl.basilisk-browser.org/${REF_REPO_ARCHIVE_FILE_NAME}"
