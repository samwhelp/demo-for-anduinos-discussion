...
DEFAULT_SUBJECT_NAME="palemoon"
REF_SUBJECT_NAME="${REF_SUBJECT_NAME:=$DEFAULT_SUBJECT_NAME}"


REF_REPO_ARCHIVE_EXTRACT_DIR_NAME="palemoon"
REF_REPO_ARCHIVE_FILE_NAME="palemoon-33.8.2.linux-x86_64-gtk3.tar.xz"
REF_REPO_ARCHIVE_URL="https://rm-us.palemoon.org/release/${REF_REPO_ARCHIVE_FILE_NAME}"
